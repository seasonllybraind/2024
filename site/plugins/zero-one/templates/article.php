...
<article role="article">
  ...
  <div class="uk-section-large uk-background-cover uk-background-center-center uk-text-center<?php e($page->parent()->inverseImageTextColor() == "true", ' uk-dark', ' uk-light') ?>"<?php if($img->extension() !== "svg"): ?> sources="[{&quot;srcset&quot;: &quot;<?= $img->thumb(['crop' => 'true', 'width' => 1920, 'height' => 900, 'format' => 'webp'])->url() ?>&quot;,&quot;type&quot;: &quot;image\/webp&quot;}]"<?php endif ?> data-src="<?= $img->crop(1920, 900)->url() ?>" style="background-color: rgba(0,0,0,0.45); background-blend-mode: overlay; background-repeat: no-repeat" uk-parallax="bgy: -50" uk-img="loading: eager">
  <?php else: ?>
