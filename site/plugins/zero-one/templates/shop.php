...
<?php endforeach ?>
<?php endif ?>
<div class="uk-container uk-margin<?php e($page->pageWidth() == "xsmall", ' uk-container-xsmall') ?><?php e($page->pageWidth() == "small", ' uk-container-small') ?><?php e($img = $page->header()->toFile() or $img = $site->header()->toFile(), ' uk-margin-large', ' uk-margin-large-bottom') ?>" uk-scrollspy="cls: uk-animation-slide-bottom-small; target: section > div; delay: 100">
