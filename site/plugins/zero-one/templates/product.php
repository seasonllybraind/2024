                                    ...
                                    <li>
                                        <a href="<?= $img->url() ?>" alt="<?= $img->alt() ?>" data-no-swup data-caption="<?= $img->caption() ?>">
                                            <picture>
                                                ...
                                                <img src="<?php e($img->getClip() !== null, $img->clip(null, $coverimg_height)->url(), $img->crop($coverimg_width, $coverimg_height)->url()) ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $img->alt() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>">
                                            </picture>
                                        </a>
                                    </li>
                                <?php
                    ...
                    <?php else: ?>
                        ...
                        <div class="uk-margin<?php e($productVariation->variationLayout() == "horizontal", ' uk-form-horizontal') ?>">
                            ...
                            <div class="uk-form-control">
                                <select id="<?= $productVariation->variationName()->slug() ?>" class="uk-select uk-width-1-2@m">
