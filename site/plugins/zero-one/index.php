...
// temporary solution for PHP 8.2 dynamic properties depreciation warnings, until all plugins upgrade
...
Kirby::plugin('zero/zero-one', [
    'blueprints' => [
        ...
        'sections/site-email' => __DIR__ . '/blueprints/sections/site-email.yml',

        // Tabs
        'tabs/page-advanced' => __DIR__ . '/blueprints/tabs/page-advanced.yml',
        ...
        'tabs/site-seo' => __DIR__ . '/blueprints/tabs/site-seo.yml',
      ...
      'snippets' => [
        ...
        'header/head/schema' => __DIR__ . '/snippets/header/head/schema.php',
